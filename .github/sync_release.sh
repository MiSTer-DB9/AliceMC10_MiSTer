...
UPSTREAM_REPO="https://github.com/MiSTer-devel/AliceMC10_MiSTer.git"
CORE_NAME=(AliceMC10)
...
UPSTREAM_CORE_NAME=(AliceMC10)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(AliceMC10.qpf)
COMPILATION_OUTPUT=(output_files/AliceMC10.rbf)
